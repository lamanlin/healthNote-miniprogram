...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.onMounted(() => {
      common_vendor.onMounted(() => {
        setTimeout(() => {
          formData.create_time = Date.parse(new Date());
        }, 0);
      });
    });
    function submit(ref) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.o(($event) => formData.create_time = $event),
        e: common_vendor.p({
          type: "create_time",
          ["clear-icon"]: false,
        ...
        n: common_vendor.sr(ruleFormRef, "b77e81d9-0", {
          "k": "ruleFormRef"
        }),
        o: common_vendor.p({
          rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-b77e81d9"], ["__file", "D:/code/miniprogram/healthNote-miniprogram/note/pages/add/addSuger.vue"]]);
